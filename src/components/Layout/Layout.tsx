  ...
  return (
    <div className="flex w-full min-h-screen h-full overflow-y-hidden">
      ...
      <div className="w-full relative overflow-y-auto scroll-smooth scrollbar-thin scrollbar-track-inherit scrollbar-thumb-zinc-800">
        <Navbar />
        {/* <Protected> */}
        <div className="w-full absolute md:mt-[2rem]  mt-[8rem]  ">
          <div className="absolute -top-10 z-[-2] min-h-[104%] w-full bg-[#000000] bg-[radial-gradient(#ffffff1f_1px,#09090b_1px)] bg-[size:20px_20px]"></div>
          {children}
        </div>
        {/* </Protected> */}
      </div>
