  ...
  return (
    <div className=" w-full h-screen flex relative overflow-hidden">
      ...
      <div className="w-full h-screen">
        <div className="flex items-center max-md:justify-center h-full sm:w-full w-[100%]  md:px-[8rem]   ">
          <LoginForm />
        </div>
      </div>
      <div className="flex flex-col items-center gap-2 -rotate-[30deg] absolute lg:right-20 md:right-10 right-1 md:translate-x-0 translate-x-[80%] md:translate-y-[-50%] translate-y-[-100%]">
